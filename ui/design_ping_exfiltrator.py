...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.ip_line, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ip_line.setPlaceholderText(_translate("MainWindow", "127.0.0.1"))
        self.interface_box.setToolTip(_translate("MainWindow", "Select your network interface"))
